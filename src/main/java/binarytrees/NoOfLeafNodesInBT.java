...
public class NoOfLeafNodesInBT {
	...
	public static void main(String[] args) {
		...
		System.out.println(noOfLeafNodes(head));
	}

	private static int noOfLeafNodes(Node head) {
		...
		return (noOfLeafNodes(head.lChild) + noOfLeafNodes(head.rChild));
