...
public class SearchValueInBT {
	...
	public static void main(String[] args) {
		...
		int key = 98;
		System.out.println(SearchValueinBT(head, key));
	}

	private static boolean SearchValueinBT(Node head, int key) {
		...
		return SearchValueinBT(head.lChild, key) || SearchValueinBT(head.rChild, key);
