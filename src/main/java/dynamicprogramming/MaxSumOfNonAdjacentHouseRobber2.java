...
public class MaxSumOfNonAdjacentHouseRobber2 {
	...
	static long robStreet(int n, ArrayList<Integer> arr) {
		...
		// breaking into two different arrays one is execluding first element and
		// another is execluding last element
		...
		// calling solve two times for both the arrays
