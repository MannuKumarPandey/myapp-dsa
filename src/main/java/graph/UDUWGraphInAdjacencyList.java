...
public class UDUWGraphInAdjacencyList {
	...
	public static void main(String[] args) {
		...
		// Add node 1 to 3: So since given graph is undirected that means 
		// we have the option to traverse from both the direction
		adj.get(1).add(3);
		adj.get(3).add(1);
