...
public class NoOfIslands2 {
    ...
    // the 8 neighbours as adjacent vertices --------------------matlab sare
    // directions se conencted dekhna hai because land kisi bhi directions(even
    // diagonally bhi connected to usko
    // connected hi manenge)
